    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        <View style={styles.textEntryContainer}>
          <TextInput style={styles.textEntryElement} value={taskText} onChangeText={text => setTaskText(text)} onFocus={() => clearOrEditText()} onBlur={() => saveOrResetText()} multiline={true} />
